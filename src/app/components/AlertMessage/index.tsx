...
const AlertMessage = ({ message, type, display }: AlertMessageProps) => {
  return (
    <div
      className={`absolute rounded p-19 left-1/2 bottom-[155px] -translate-x-1/2 desktop:py-6 desktop:px-8 w-11/12 desktop:bottom-auto desktop:left-[calc(100%_-_2.5rem)] desktop:w-426 desktop:-translate-x-0 desktop:top-[45px] transition-opacity duration-500 ${
